...
ax.bar(x, p1_before, color=BLUE, label="Baseline")
...
ax.axhline(sum(p1_before)/len(p1_before), color=BLUE, linestyle="--", alpha=0.6, label=f"Baseline Avg {sum(p1_before)/len(p1_before):.1f}%")
ax.legend(); ax.grid(axis="y", alpha=0.3)
save(fig, "phase1_before.png")

# before + after
fig, ax = plt.subplots(figsize=(10, 5))
ax.bar(x - BAR_W/2, p1_before, BAR_W, color=BLUE, label="Baseline")
ax.bar(x + BAR_W/2, p1_after,  BAR_W, color=GREEN, label="Post-Alignment")
ax.set_xticks(x); ax.set_xticklabels(domains, fontsize=9)
ax.set_ylabel("Accuracy (%)"); ax.set_ylim(0, 100)
...
ax.bar(x2, p2_before, color=BLUE, label="Baseline")
...
fig, ax = plt.subplots(figsize=(7, 5))
ax.bar(x2 - BAR_W/2, p2_before, BAR_W, color=BLUE, label="Baseline")
ax.bar(x2 + BAR_W/2, p2_after,  BAR_W, color=GREEN, label="Post-Alignment")
ax.set_xticks(x2); ax.set_xticklabels(metrics, fontsize=10)
ax.set_ylabel("Score"); ax.set_ylim(0, 100)
...
ax.bar(x3, p3_before, color=BLUE, label="Baseline")
...
ax.axhline(avg_b, color=BLUE, linestyle="--", alpha=0.6, label=f"Baseline Avg {avg_b:.1f}%")
ax.legend(); ax.grid(axis="y", alpha=0.3)
save(fig, "phase3_before.png")

fig, ax = plt.subplots(figsize=(9, 5))
ax.bar(x3 - BAR_W/2, p3_before, BAR_W, color=BLUE, label="Baseline")
ax.bar(x3 + BAR_W/2, p3_after,  BAR_W, color=GREEN, label="Post-Alignment")
ax.set_xticks(x3); ax.set_xticklabels(langs, fontsize=10)
ax.set_ylabel("Accuracy (%)"); ax.set_ylim(0, 100)
