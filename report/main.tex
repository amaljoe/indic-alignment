...
\title{%
    ...
    \normalsize CS6103: Human Centered AI, IIT Bombay\\
...
Only the English data (5k pairs) was pre-existing. All six Indic language datasets were created by translating the English pairs using Gemma 3 27B with 128 concurrent API calls, preserving the \texttt{\textbackslash n\textbackslash nHuman:} / \texttt{\textbackslash n\textbackslash nAssistant:} conversation markers verbatim. Hindi and Malayalam received 5k pairs each; Tamil, Bengali, Telugu, and Marathi received $\sim$2k each. The HHH evaluation set (221 examples per language) was also translated for held-out multilingual evaluation.
